...
@ConfigurationProperties(prefix = "jmix.sqs.yandexqueue")
@ConstructorBinding
public class QueuePropertiesYandex implements QueueProperties {
    ...
    public QueuePropertiesYandex(@Nullable String accessKey,
                                 @Nullable String secretKey,
                                 @Nullable String region,
                                 @Nullable String endpointConfiguration,
