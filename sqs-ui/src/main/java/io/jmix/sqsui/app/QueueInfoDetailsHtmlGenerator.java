...
@Component("sqs_QueueInfoDetailsHtmlGenerator")
public class QueueInfoDetailsHtmlGenerator {
    ...
    public String generateTableHtml(QueueInfo queueInfo) {
        ...
        sb.append("<table spacing=3px padding=3px>")
                .append("<tr>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.Created")).append("</th>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.MaximumMessageSize")).append("</th>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.LastUpdated")).append("</th>")
                .append("<th></th>")
                .append("</tr>");
        sb.append("<tr>");
        ...
        sb.append("<td>").append(awsFormat(queueInfo.getQueueAttributes().getMaximumMessageSize(), Long.class))
                .append(" ").append(messages.getMessage("io.jmix.sqsui.app/Bytes")).append("</td>");
        sb.append("<td>").append(awsFormat(queueInfo.getLastUpdate(), LocalDateTime.class)).append("</td>");
        sb.append("</tr>").append("</table>");
        sb.append("<table spacing=3px padding=3px>")
                .append("<tr>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.MessageRetentionPeriod")).append("</th>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.DefaultVisibilityTimeout")).append("</th>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.MessagesAvailable")).append("</th>")
                .append("</tr>");
        sb.append("<tr>");
        sb.append("<td>").append(awsFormat(queueInfo.getQueueAttributes().getMessageRetentionPeriod(), Long.class))
                .append(" ").append(messages.getMessage("io.jmix.sqsui.app/TimeSecs")).append("</td>");
        ...
        sb.append("<table spacing=3px padding=3px>")
                .append("<tr>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.DeliveryDelay")).append("</th>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.MessagesInFlight")).append("</th>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.ReceiveMessageWaitTime")).append("</th>")
                .append("</tr>");
        sb.append("<tr>");
        ...
        sb.append("<table spacing=3px padding=3px>")
                .append("<tr>")
                .append("<th>").append(messages.getMessage("io.jmix.sqsui.app/tableDetails.MessagesDelayed")).append("</th>")
                .append("</tr>");
        sb.append("<tr>");
